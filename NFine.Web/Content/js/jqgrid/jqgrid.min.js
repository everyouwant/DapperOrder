    ...
    $.fn.jqGrid = function (pin) {
        ...
        return this.each(function () {
                ...
                if (pgboxes) {
                    ...
                    if (ts.p.viewrecords) {
                        if (ts.p.reccount === 0) {
                            ...
                            $(".ui-paging-info", pgboxes).html($.jgrid.template(rt, from, to, tot, (Number(ts.p.totaltime) + Number(ts.p.costtime))));
                        }
                    }
            ...
            $(grid.bDiv)
                ...
                .css({ height: ts.p.height - 36 + (isNaN(ts.p.height) ? "" : "px"), width: (grid.width - bstw) + "px" })
